...
#classifier
faceCascade = cv2.CascadeClassifier('face_xml/haarcascade_frontalface_default.xml')
...
while True: 
    ...
    gray = cv2.cvtColor(frame, cv2.COLOR_B4GR2GRAY) #흑백으로
    ...
    elif count >= 10 : break #100 face sample
